...
int main (int argc, char **argv)
{
  ...
  // environment
	...
	{
		Scene->AddGeom(geom=dCreateBox(0,2,1.5,1));
		dGeomSetPosition(geom,-i*3,0,0);
	}
#define FACE_ROOT_COUNT	20

  	for(i=0;i<FACE_ROOT_COUNT;i++)
  	{
