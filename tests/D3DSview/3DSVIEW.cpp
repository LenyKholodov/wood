...
k3DSMODEL k3dsModel; // structure to store 3ds model data
...
//-----------------------------------------------------------------------------
class CMyD3DApplication : public CD3DApplication, public C3DS
{
                  ...
                  :CD3DApplication()
{
    ...
    m_strWindowTitle  = TEXT("D3DS View v2.0");
...
HRESULT CMyD3DApplication::OneTimeSceneInit()
{
	...
	if( Load3dsModel(&k3dsModel, "jeep2.3ds" ) == FALSE )
		PrintMessage("Couldn't load model", NULL);
	else
		PrintMessage("CMyD3DApplication::OneTimeSceneInit() Loaded", "jeep2.3ds");

	// Dump contents of k3dsModel to a file called
	// 3dsmodel.txt for debugging
	Write_k3dsmodel_debugfile(&k3dsModel);
...
HRESULT CMyD3DApplication::Render()
{
    ...
    {	
		Render3DSModel(m_pd3dDevice, 
					  0.0f, -15.0f, 0.0f, // place the model at world co-ordinate (x,y,z)
					  45.0f, // rotate model around y axis by this angle
					  0,     // animation frame number (not used yet)
					  &k3dsModel); // pointer to 3ds model structure
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    D3DVECTOR vEyePt    = D3DVECTOR( 0.0f, 0.0f, -25.0f );
